 ...
 * notification. Enqueued by the geofence receiver and by time triggers.
 */
class ConnectionLookupWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        val reschedule = inputData.getBoolean(KEY_RESCHEDULE, false)
        try {
            ...
            if (reschedule) {
                container.timeTriggerScheduler.schedule(watcher)
            }
        }
    }
    ...
    companion object {
        ...
        const val KEY_RESCHEDULE = "reschedule"
